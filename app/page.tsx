...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Navegar al dashboard tras el login
    router.push("/dashboard")
  }

  const handleSocialLogin = (provider: string) => {
    console.log("Social login with:", provider)
    // Navegar al dashboard tras login social
    router.push("/dashboard")
  }
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/background-white.jpg')",
        ...
        <CardContent className="space-y-6">
          ...
          <div className="text-center">
            <button
              ...
              className="text-sm text-card-foreground/70 hover:text-card-foreground font-sans transition-colors cursor-pointer bg-transparent border-none p-0"
            >
